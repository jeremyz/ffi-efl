...
module Efl
    ...
    module Elm
        ...
        def self.method_missing m, *args, &block
            sym = 'elm_'+m.to_s
            raise NameError.new "#{self.name}.#{sym} (#{m})" if not Efl::Elm::Native.respond_to? sym
            self.module_eval "def self.#{m} *args, &block; r=Efl::Elm::Native.#{sym}(*args); yield r if block_given?; r; end"
        ...
        module Native
            ...
            enum :elm_actionslider_pos, [ :elm_actionslider_none, 0, :elm_actionslider_left, 1, :elm_actionslider_center, 1, :elm_actionslider_right,
                1, :elm_actionslider_all ]
            ...
            enum :elm_transit_effect_wipe_dir, [ :elm_transit_effect_wipe_dir_left, :elm_transit_effect_wipe_dir_right,
            ...
            [ :elm_diskselector_item_tooltip_content_cb_set, [ :elm_diskselector_item_p, :elm_tooltip_item_content_cb, :void_p, :evas_smart_cb ],
                :void ],
