...
module Efl
    ...
    module Evas
        ...
        def self.method_missing m, *args, &block
            sym = 'evas_'+m.to_s
            raise NameError.new "#{self.name}.#{sym} (#{m})" if not Efl::Evas::Native.respond_to? sym
            self.module_eval "def self.#{m} *args, &block; r=Efl::Evas::Native.#{sym}(*args); yield r if block_given?; r; end"
        ...
        module Native
            ...
            enum :evas_render_op, [ :evas_render_blend, 0, :evas_render_blend_rel, 1, :evas_render_copy, 2, :evas_render_copy_rel, 3,
                :evas_render_add, 4, :evas_render_add_rel, 5, :evas_render_sub, 6, :evas_render_sub_rel, 7, :evas_render_tint, 8, :evas_render_tint_rel, 9,
                :evas_render_mask, 1, :evas_render_mul, 1 ]
            ...
            [ :evas_event_feed_multi_down, [ :evas_p, :int, :int, :int, :double, :double, :double, :double, :double, :double, :double,
                :evas_button_flags, :uint, :void_p ], :void ],
            ...
            [ :evas_event_feed_multi_up, [ :evas_p, :int, :int, :int, :double, :double, :double, :double, :double, :double, :double,
                :evas_button_flags, :uint, :void_p ], :void ],
            ...
            [ :evas_object_smart_callbacks_descriptions_get, [ :evas_object_p, :evas_smart_cb_description_ppp, :uint_p,
                :evas_smart_cb_description_ppp, :uint_p ], :void ],
