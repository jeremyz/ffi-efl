...
module Efl
    ...
    module Eet
        ...
        def self.method_missing m, *args, &block
            sym = 'eet_'+m.to_s
            raise NameError.new "#{self.name}.#{sym} (#{m})" if not Efl::Eet::Native.respond_to? sym
            self.module_eval "def self.#{m} *args, &block; r=Efl::Eet::Native.#{sym}(*args); yield r if block_given?; r; end"
        ...
        module Native
            ...
            [ :eet_data_image_read_to_surface, [ :eet_file_p, :string, :uint, :uint, :uint_p, :uint, :uint, :uint, :int_p, :int_p, :int_p, :int_p ],
                :int ],
            ...
            [ :eet_data_image_read_to_surface_cipher, [ :eet_file_p, :string, :string, :uint, :uint, :uint_p, :uint, :uint, :uint, :int_p, :int_p,
                :int_p, :int_p ], :int ],
