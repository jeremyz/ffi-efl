...
module Efl
    ...
    module Ecore
        ...
        def self.method_missing m, *args, &block
            sym = 'ecore_'+m.to_s
            raise NameError.new "#{self.name}.#{sym} (#{m})" if not Efl::Ecore::Native.respond_to? sym
            self.module_eval "def self.#{m} *args, &block; r=Efl::Ecore::Native.#{sym}(*args); yield r if block_given?; r; end"
