...
module Efl
    ...
    module EinaHash
        ...
        def self.method_missing m, *args, &block
            ...
            raise NameError.new "#{self.name}.#{sym} (#{m})" if not Efl::EinaHash::Native.respond_to? sym
            self.module_eval "def self.#{m} *args, &block; r=Efl::EinaHash::Native.#{sym}(*args); yield r if block_given?; r; end"
