...
module Efl
    ...
    module EcoreEvas
        ...
        def self.method_missing m, *args, &block
            ...
            raise NameError.new "#{self.name}.#{sym} (#{m})" if not Efl::EcoreEvas::Native.respond_to? sym
            self.module_eval "def self.#{m} *args, &block; r=Efl::EcoreEvas::Native.#{sym}(*args); yield r if block_given?; r; end"
        ...
        module Native
            ...
            enum :ecore_evas_avoid_damage_type, [ :ecore_evas_avoid_damage_none, 0, :ecore_evas_avoid_damage_expose, 1,
