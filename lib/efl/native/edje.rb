...
module Efl
    ...
    module Edje
        ...
        def self.method_missing m, *args, &block
            sym = 'edje_'+m.to_s
            raise NameError.new "#{self.name}.#{sym} (#{m})" if not Efl::Edje::Native.respond_to? sym
            self.module_eval "def self.#{m} *args, &block; r=Efl::Edje::Native.#{sym}(*args); yield r if block_given?; r; end"
        ...
        module Native
            ...
            enum :edje_message_type, [ :edje_message_none, 0, :edje_message_signal, 1, :edje_message_string, 2, :edje_message_int, 3,
                :edje_message_float, 4, :edje_message_string_set, 5, :edje_message_int_set, 6, :edje_message_float_set, 7, :edje_message_string_int, 8,
                :edje_message_string_float, 9, :edje_message_string_int_set, 1, :edje_message_string_float_set, 1 ]
            ...
            enum :edje_text_effect, [ :edje_text_effect_none, 0, :edje_text_effect_plain, 1, :edje_text_effect_outline, 2,
                :edje_text_effect_soft_outline, 3, :edje_text_effect_shadow, 4, :edje_text_effect_soft_shadow, 5, :edje_text_effect_outline_shadow, 6,
                :edje_text_effect_outline_soft_shadow, 7, :edje_text_effect_far_shadow, 8, :edje_text_effect_far_soft_shadow, 9, :edje_text_effect_glow, 1,
                :edje_text_effect_last, 1, :edje_text_effect_shadow_direction_bottom_right, :edje_text_effect_shadow_direction_bottom,
                :edje_text_effect_shadow_direction_bottom_left, :edje_text_effect_shadow_direction_left, :edje_text_effect_shadow_direction_top_left,
                :edje_text_effect_shadow_direction_top, :edje_text_effect_shadow_direction_top_right, :edje_text_effect_shadow_direction_right ]
            ...
            enum :edje_tween_mode, [ :edje_tween_mode_none, 0, :edje_tween_mode_linear, 1, :edje_tween_mode_sinusoidal, 2,
                :edje_tween_mode_accelerate, 3, :edje_tween_mode_decelerate, 4, :edje_tween_mode_last, 5 ]
