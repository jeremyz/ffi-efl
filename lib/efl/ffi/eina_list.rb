...
module Efl
    ...
    module FFI
        ...
        # EAPI void *eina_list_data_find(const Eina_List *list, const void *data) EINA_PURE;
        [ :eina_list_data_find, [ :eina_list_p, :void_p ], :void_p ],
        # EAPI Eina_List *eina_list_data_find_list(const Eina_List *list, const void *data) EINA_PURE;
